...
if use_dhg_dataset:
    ...
    def load_data(filepath='./dhg_data_14.pckl'):
        """
    ...
    x_train, x_test, y_train_14, y_test_14 = load_data('dhg_data_14.pckl')
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), 'gesture_pretrained_model_14c_80_3-14.pt')